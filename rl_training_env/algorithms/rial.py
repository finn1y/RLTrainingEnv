...
class RIAL(DDRQN):
    ...
    def __init__(self, sizes, gamma=0.99, epsilon_max=1.0, epsilon_min=0.01, lr=0.0001, lr_decay=0.9, lr_decay_steps=10000, saved_path=None):
        ...
        """
        super(RIAL, self).__init__(sizes, gamma=gamma, epsilon_max=epsilon_max, epsilon_min=epsilon_min, lr=lr, lr_decay=lr_decay, lr_decay_steps=lr_decay_steps, saved_path=saved_path)
